...
# STOCK 1: AAPL Appl
# ============================================================
getSymbols("AAPL", from = "1999-12-01", to = "2025-11-02", periodicity = "monthly")
...
# STOCK 3: NVDA Nvidia
# ============================================================
getSymbols("NVDA", from = "1999-12-01", to = "2025-11-02", periodicity = "monthly")
data3 <- as.data.frame(NVDA)
...
# STOCK 4: AMZN Amazon
# ============================================================
getSymbols("AMZN", from = "1999-12-01", to = "2025-11-02", periodicity = "monthly")
...
# ============================================================
# STOCK 5: GOOGL Google (Alphabet)
# ============================================================
getSymbols("GOOGL", from = "1999-12-01", to = "2025-11-02", periodicity = "monthly")
data5 <- as.data.frame(GOOGL)
...
mean_return5 <- (1 + (data5$adjusted_close[256] - data5$adjusted_close[1]) / data5$adjusted_close[1])^(1/312)

# ============================================================
# Risk-free rate (3-month Treasury)
# ============================================================
getSymbols("DGS3MO", src = "FRED", from = "1999-12-01", to = "2025-11-02")
...
sp500_monthly_255 <- tail(sp500_monthly, 255)
prices_sp500_255 <- sp500_monthly_255$adjusted_close
returns_sp500_255 <- na.omit(sp500_monthly_255$returns)
std_dev_sp500_255 <- sd(returns_sp500_255)
...
cov_stock5_sp500 <- cov(returns5, returns_sp500_255)
...
beta5 <- cov(returns5, returns_sp500_255) / var(returns_sp500_255, na.rm = TRUE)
...
data5_94_obs <- data5[1:94, ]
sp500_monthly_150_obs <- sp500_monthly[1:150, ]
sp500_monthly_94_obs <- sp500_monthly[1:94, ]
...
returns5_94_obs <- na.omit(data5_94_obs$returns)
returns_sp500_150_obs <- na.omit(sp500_monthly_150_obs$returns)
returns_sp500_94_obs <- na.omit(sp500_monthly_94_obs$returns)
...
cov_stock5_sp500_94 <- cov(returns5_94_obs, returns_sp500_94_obs)

variance_sp500_150 <- var(returns_sp500_150_obs, na.rm = TRUE)
variance_sp500_94 <- var(returns_sp500_94_obs, na.rm = TRUE)
...
beta5_94 <- cov(returns5_94_obs, returns_sp500_94_obs) / var(returns_sp500_94_obs, na.rm = TRUE)

returns_sp500_150_obs <- as.numeric(na.omit(sp500_monthly_150_obs$returns))
returns_sp500_94_obs <- as.numeric(na.omit(sp500_monthly_94_obs$returns))
View(returns_sp500_150_obs)
View(returns_sp500_94_obs)
...
mean_return_sp500_94_monthly <- geometric_mean_returns(returns_sp500_94_obs)
mean_return_sp500_94 <- ((1 + mean_return_sp500_94_monthly)^12) - 1
mean_return_sp500_94_monthly_pct <- mean_return_sp500_94_monthly*100
mean_return_sp500_94_pct <- mean_return_sp500_94*100
# ============================================================
...
rf_capm_94 <- rf_3m[1:94, ] %>% select(-ym)
rf_capm_94

rf_capm_94$value <- as.numeric(as.character(rf_capm_94$value))
mean_rf_capm_94 <- mean(rf_capm_94$value, na.rm = TRUE)
mean_rf_capm_94
...
expected_return_5_94 <- mean_rf_capm_94 + beta5_94 * (mean_return_sp500_94_pct - mean_rf_capm_94)
