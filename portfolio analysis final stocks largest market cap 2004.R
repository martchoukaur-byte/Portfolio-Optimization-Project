...
# ============================================================
# STOCK 1: GE General Eletric
# ============================================================
data <- av_get(symbol = "GE", 
...
# ============================================================
# STOCK 3: XOM ExxonMobil
# ============================================================
data3 <- av_get(symbol = "NVDA", 
                av_fun = "TIME_SERIES_MONTHLY_ADJUSTED", 
                outputsize = "full")
...
# ============================================================
# QUESTION 6: WEALTH EVOLUTION OVER TIME (WITH S&P 500)
# ============================================================
...
# Merge with your existing wealth_data
wealth_data <- wealth_data %>%
  left_join(wealth_sp500_data, by = "Year")
